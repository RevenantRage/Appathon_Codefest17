                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if(shopObj.size()==0){
                            ...
                            ListAdapter adapter = new ArrayAdapter<>(getApplicationContext(),android.R.layout.simple_list_item_1,shopname);
