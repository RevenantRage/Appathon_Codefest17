...
public class ShopKeeperDetails extends AppCompatActivity {
     ...
     public  void ConfirmRequest(View v){
         if (swtch.isChecked()){
             ...
             if (network) {
                 ...
                 PutNotifiationAlert putNotifiationAlert = new PutNotifiationAlert(email, umail,responseListener);
    ...
    public void  putText(){
        ...
        if(url.matches( "http://thinkers.890m.com/customer/twoWheelerDetails.php")){
            ...
            ListAdapter adapter = new ArrayAdapter<>(getApplicationContext(),android.R.layout.simple_list_item_1,service);
